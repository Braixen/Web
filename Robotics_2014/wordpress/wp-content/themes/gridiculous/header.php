...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="http://fonts.googleapis.com/css?family=Russo+One|Lato:300,900" >
...
<body <?php body_class(); ?>>
	...
	<div id="page" class="grid<?php echo ' ' . gridiculous_theme_options( 'width' ); ?>">
		...
		<?php if ( gridiculous_theme_options( 'home_widget' ) && is_home() && 2 > $paged ) { ?>
