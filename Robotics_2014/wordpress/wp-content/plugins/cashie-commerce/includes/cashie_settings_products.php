...
<div class="wrap">
    <?php if ($this->update && $this->option_values['mode']=="add") { ?>
		...
		<?php } ?>
    <?php if ($_GET['update']==1 && $this->option_values['mode']=="add") { ?>
   ...
   <iframe id="cashie_frame" src="<?php echo $this->cashie_url; ?>/account/catalog?<?php echo $this->cashie_url_vars; ?>&origin=<?php echo urlencode($origin); ?>&returnURL=<?php echo urlencode($returnURL); ?>" width="930" height="1800" frameborder="0"></iframe>
